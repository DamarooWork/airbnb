...
export default function TripCancel({ bookingId }: TripCancelProps) {
  ...
  return (
    <>
      <TrashIcon
        onClick={openConfirm}
        className="absolute size-6 top-4 right-4 cursor-pointer text-primary  hover:scale-110 transition-transform duration-300 ease-in-out will-change-transform active:scale-95"
      >
        Cancel Reservation
      </TrashIcon>
